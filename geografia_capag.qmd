...
-   Número de municípios com notas não atribuídas só é inferior ao número de municípios com nota B
...
-   A proporção de notas A tem destaque no RS
-   Proporções importantes de notas não definidas em GO, TO e PA
...
## Distribuição desproporcional nos estados

-   57% das combinações possíveis entre estados e categorias de notas estão associadas a resíduos padronizados significativos
-   Esse achado pode indicar associação entre aspectos regionais e comportamento fiscal medido pela CAPAG
...
## Distribuição desproporcional nos estados - Diferenças

-   A combinação RS-Nota A aparece com a maior diferença positiva entre esperado e observado no teste estatístico
-   Outra combinação com diferença positiva importante é GO-n.d
...
## Distribuição desproporcional nos estados - CAPAG A

-   Oito estados estão positivamente associados a CAPAG A
-   Treze estados estão negativamente associados a CAPAG A
...
## Mapas distribuição desproporicional nos estados - CAPAG A (estados positivamente associados)

-   Na comparação entre mapas observa-se adensamento de nuvens de pontos principalmente no Noroeste do RS e Oeste de SC
...
sedes_municipios %>%
  ...
  labs(
    title = "Um mapa esperado",
    caption = "Mapa aleatório com número de pontos esperado"
  )
...
sedes_municipios %>%
  ...
  labs(
    title = "Mapa observado",
    caption = "Mapa com os dados efetivamente observados"
  )
# 
# 
m1+m2
...
## Mapas distribuição anormal nos estados - CAPAG A

- O zoom nos mapas do RS deixam mais claro o adensamento
...
## Mapa distribuição desproporcional nos estados - CAPAG A (estados negativamente associados)

- O efeito de oito dos nove estados do NE estarem negativamente associados à nota A é notório na comparação dos mapas
...
## Mapa distribuição desproporicional nos estados - CAPAG A
...
## Distribuição desproporcional nos estados - CAPAG B

- Seis estados estão positivamente associados à nota B
- Oito estados estão negativamente associados à nota B
...
## Mapa distribuição desproporcional nos estados - CAPAG B (estados positivamente associados)

- Observa-se um maior adensamento de pontos em todo estado de SC na comparação entre os dois mapas
...
## Mapa distribuição anormal nos estados - CAPAG B (estados negativamente associados)

- É fácil observar a redução do número de pontos em PA, TO e GO
...
- 11 estados positivamente associados à nota C
- 10 estados negativamente associados à nota C
...
## Mapa distribuição desproporcional nos estados - CAPAG C (estados positivamente associados)

- Oito dos nove estados do Nordeste positivamente associados à CAPAG C
...
## Mapa distribuição desproporcional nos estados - CAPAG C (estados negativamente associados)

- A redução do número de pontos é facilmente verificável para MG, SC e SP
...
## Mapa distribuição desproporcional nos estados - Nota não definida (estdos positivamente associados)

- Observa-se com facilidade o expressivo aumento do número de pontos principalmente em Goiás
...
## Mapa distribuição desproporcional nos estados - Nota não definida (estdos negativamente associados)

- Baixo adensamento de pontos no RS e em SC na comparação entre os mapas
- Quase ausência de pontos no ES no mapa da direita
...
- 34% das combinações estão associadas a resíduos relevantes
- No geral não há fortes ligações entre aspectos de influência e gestão e notas CAPAG 
...
## Distribuição desprorcionais nos níveis REGIC - Diferenças

- Centros locais se destacam nas diferenças positivas (.n.d.) e negativas (nota B) 
...
- Arranjos populacionais caracterizados pela gravitação em torno de um polo destaca-se na nota A
...
## Distribuição anormal nos níveis hierárquicos - Arranjos populacionais x CAPAG A

- Pela proximidades dos pontos não é possível perceber no mapa completo do Brasil o contraste entre os o observado e esperado, mas a associação positiva desse tipo de município indica a possibilidade de se analisar clusters espaciais como relevante para a construção de notas CAPAG
...
- Contraste forte entre os centos locais e os outros níveis indicando associação positiva entre Centros Locais e .n.d.
...
## Distribuição desproporcional nos níveis hierárquicos - Centros locais x CAPAG n.d

- Em todo o território nacional os centos locais apresentam-se como destaque na não determinação de notas de CAPAG
...
## Distribuição desproporcional nos níveis hierárquicos - CAPAG B

- Novamente os centros locais se destacam na comparação com outros níveis hierárquicos. Dessa vez com sinal negativo
...
## Distribuição desproporcional nos níveis hierárquicos - Centro local x CAPAG B

- O contraste entre um mapa aleatório esperado e  mapa observado mostra redução do número de pontos referentes a centros locais em todo o Brasil 
...
- Valores de média dos indicadores 1 para cada cluster bem distribuídos no box-plot
- Mediana de Coeficiente de Variação baixa mas com outliers importantes
...
- Vários clusters convergentes no CE e BA
- Clusters convergentes com baixo indicador em MG e no MA
...
- Distribuição desequilibrada das médias com mediana menor do que o dos clusters convergentes.
- Coeficiente de variação bem maisl elevado que os clusters divergentes
...
- Clusters divergentes com grande coeficiente de variação no Piauí e Maranhão
...
- Box-plots de média e CV com intervalos interquatis bastante concentrados
- Baixo CV 
- Médias elevadas
...
- Poucas ocorrências de clusters espaciais concentrados principalmente na região Norte
...
- Box plots com grande dispersão
- Médias ainda mais elevadas do que os clusters convergentes
- CVs também com valores mais elevados que os clusters convergentes
...
- Box plots revelam grande dispersão de média e CV
- Médias elevadas
...
## Clusters convergentes indicador 3: mapas

- Clusters com maior ocorrência no Nordeste
- Nenhuma ocorrência no Sul
...
- Box-plots com grandes dispersões
- Média e CV bem mais elevados do que os clusters convergentes
...
## Clusters divergentes indicador 3: mapas

- Clusters espalhados pelo Norte, Nordeste e MG
...
- Número muito grande de valores ausentes para o indicador 3 (1231 ocorrências)
- Associação importante do fenômeno com municípios de menor possivlelmente há um gatilho para populações menores que 68 mil habitantes
